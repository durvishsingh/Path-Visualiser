...
function App() {
    ...
    const [showTutorialModal,setShowTutorialModel]=useState(true);
    ...
    return (
        <React.Fragment>
            ...
            <footer className="footer">
                <p className="footer__author">path_visualizer_app by @durvish99</p>
                <a  
                    href="https://github.com/durvishsingh"
                    target="_blank"
